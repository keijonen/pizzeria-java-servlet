...
<%if(asiakas.getId() != 0){ %>
<div class="ylapalkki">
<p1><%out.print("Olet kirjautunut nimellä: "+asiakas.getEtunimi()+" "+asiakas.getSukunimi()); %></p1>
...
<%}%>
<br>
<span class="valkoinen">Käyttäjätunnuksen luominen epäonnistui, yritä uudelleen.</span>
<br>
<br>
<nav>
...
<a href="luotunnus.jsp">
<img src="kuvat/uudet/luotunnus_nabu1.png" 
onmouseover="this.src='kuvat/uudet/luotunnus_nabu2.png'"
onmouseout="this.src='kuvat/uudet/luotunnus_nabu1.png'"/></a>
