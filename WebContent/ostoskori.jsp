...
<article>
<h2>Tilaa herkkupizzasi täältä!</h2>

<p>Pöytävaraukset suoraan salivastaavalta puhelimitse tai sähköpostitsepostitse.
</p>
...
<c:forEach items="${lista}"  var="lista" >
	...
	<br>
	Määrä: &nbsp<c:out value="${lista.maara}" />&nbsp
	<br>
	<br>
	Hinta yhteensä:<b> &nbsp<c:out value="${lista.hintayht}" />&nbsp</b>
	<br>
</c:forEach>
	Pizzojen määrä yhteensä: <b><%= session.getAttribute("kpl") %></b>
	<br>
	<br>
	<b>Pizzojen hinta yhteensä: <font color="#B51112"><%= session.getAttribute("hintayht") %></font></b>
	<br>
	<br>
	<form action="Controller" method="get">
<input type="submit" name="action" value="Tyhjennä ostoskori"/>
</form>
</c:if>
...
<p>Ostoskorissasi ei ole yhtään tuotetta.</p>
	...
	Puhelin:
	<br><input type="number" min="6" title="Anna vähintään 6 numeroa."	name="puhelin" required><br>
	Sähköposti:
	<br><input type="email"	name="mail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="Anna sähköposti oikeassa muodossa."required><br>
	<br><input type="submit" name="action" value="Tilauksen lähetys"/> 
	<br></br>
	<%}%>
	...
	<br>
	<input type="submit" name="action" value="Tilauksen lähetys"/>
	<br>
	<br>
	<%}%>
</form>
